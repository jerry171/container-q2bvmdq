...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-q2bvmdq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-q2bvmdq.containers.anotherwebservice.com/
...
```
git clone git@github.com:jerry171/container-q2bvmdq.git
cd container-q2bvmdq
```
...
```
docker attach container-q2bvmdq
```
